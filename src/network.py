...
def getNetworks(fabric, network_dir="networks", network_template_config_dir="network_templates", network_filter="", range=0):
...
def getNetwork(fabric, network_name, network_dir="networks", network_template_config_dir="network_templates"):
...
if __name__ == "__main__":
    # getNetworks(fabric="Site1-Greenfield", network_dir="networks", network_template_config_dir="network_templates", network_filter="", range=10)
    # getNetwork(fabric="Site1-Greenfield", network_name="bluenet1", network_dir="networks", network_template_config_dir="network_templates")
    getNetworks(fabric="Site1-TSMC", network_dir="networks", network_template_config_dir="network_templates", network_filter="", range=0)
    # createNetwork(filename="networks/Site1-TSMC_30000_bluenet1.json", network_template_config_file="network_templates/Site1-TSMC_30000_bluenet1.json")
    # updateNetwork(filename="networks/Site1-TSMC_30000_bluenet1.json", network_template_config_file="network_templates/Site1-TSMC_30000_bluenet1.json")
